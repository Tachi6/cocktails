import { obtainGlobalValoration, uploadAverage, uploadRating } from '../models/bestCockailsDB.js';
import { checkData } from '../modules/checkData.js';
import { showPopUpMessage } from '../views/popUpView.js';
import { updateGlobalValoration } from '../views/presentationView.js';
    ...
    star.addEventListener(
      ...
      async () => {
        ...
        if (rating.presentation !== 0 && rating.creativity !== 0 && rating.valoration !== 0) {
          ...
          // Obtain new global valoration
          const globalValoration = await checkData(() => obtainGlobalValoration(cocktailId));
          console.log(globalValoration);

          // Update globalvaloration
          await updateGlobalValoration(globalValoration);
